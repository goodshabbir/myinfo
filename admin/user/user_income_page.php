    ...
    <div class="row">
    	 <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>User's Income Information</b></h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                    ...
                    <tr> 
                        ...
                        <td><?= $row->full_name; ?></td>   
                        <td><i class="fa fa-inr"></i> <?= $row->binary_benifi; ?></td>
                        <td>0</td> 
                        <td><i class="fa fa-inr"></i> <?= $row->binary_benifi; ?>+0 = <?= $row->binary_benifi + 0; ?></td>                   
