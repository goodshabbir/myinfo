    ...
    <div class="row">
    	 <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>All User Personan Profile  List</b></h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                    ...
                    <tr> 
                       ...
                       <td></td>
                       <!-- <td>
                            <a href="<?= full_profile.'?list='.$row->id;?>" class="btn btn-pink btn-custom btn-rounded waves-effect waves-light">Get Full Profile</a>
                       </td> -->
                    </tr>
