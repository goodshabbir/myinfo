    ...
    <div class="row">
    	 <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>All User ePin History</b></h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        <th>#</th>
                        <th>Debit Sponsor</th>
                        <th>Credit Sponsor</th>
                        <th>Number Of ePin</th>
                        <th>ePin Info</th>
                        <th>Transfer Date</th>
                    </tr>
                    </thead>
                    ...
                    <?php if($row->from_user==sponsorid()|| $row->to_user==sponsorid()){?>

                    <tr> 
                        <td><?= $i++; ?></td>
                        <td><?php if ($row->from_user == sponsorid()) {echo "to :" . $row->dusraName . " " . "<b>" . $row->dusraid . "</b>" . "</br> <i class='fa fa-inr'></i>";}?></td>
                        <td><?php if($row->to_user==sponsorid()){ echo "From :".$row->firstName." <b>".$row->firstid."</b> </br> <i class='fa fa-inr'></i>"; } ?></td>
                        <td><?= count($epinInfo);?></td>
                        ...
                        <td><?php echo date('Y-m-d h:i a', strtotime($row->transfer_date));?></td>
