...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <a href="<?= edit_other_income;?>" class="btn btn-pink btn-custom btn-rounded waves-effect waves-light">Add Other Income</a>
             <br> <br>   
            <h4 class="m-t-0 header-title"><b>INCOME LIST</b></h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>  
                        ...
                        <td><i class="fa fa-inr"></i> <?= $row->incom_amount; ?></td>  
                        <td><?= $row->date; ?></td> 
                        <td><?= $row->remark; ?></td>
                        <td>
                            <a href="user/edit_other_income/<?= $row->id;?>"><i class="fa fa-edit"></i></a>
